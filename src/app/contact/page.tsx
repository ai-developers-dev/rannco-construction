...
export const metadata: Metadata = {
  ...
  description:
    "Contact Rannco Construction for a FREE consultation & estimate. Call (618) 594-1178 or email us. Serving Benton, Marion, Carbondale, Herrin, Murphysboro & all of Southern Illinois.",
  keywords: [
    "contact contractor Benton IL",
    "free construction estimate Marion",
    "construction quote Carbondale IL",
    "general contractor Southern Illinois",
    "home builder Herrin IL",
    "call contractor West Frankfort",
  ],
  openGraph: {
    title: "Contact Us for a Free Estimate | Rannco Construction",
    description:
      "Get a FREE consultation & estimate. Call (618) 594-1178. Serving all of Southern Illinois.",
  },
};
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-background/80 mb-8">
              Ready to get started? Reach out for a free, no-obligation consultation. We&apos;re
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                Based in Harrisburg, we provide quality construction services throughout
            ...
            <div className="aspect-[16/9] w-full rounded-xl overflow-hidden shadow-lg">
              <iframe
                ...
                title="Rannco Construction - 505 E Walnut St, Harrisburg, IL"
              />
            </div>
