        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-muted-foreground text-lg mb-6">
              At Rannco Construction, we&apos;ve built our reputation on quality
              workmanship, honest pricing, and exceptional customer service. From
              custom homes to commercial builds and full renovations, we bring
              expertise and dedication to every project.
            </p>
            <p className="text-muted-foreground mb-8">
              As a locally owned and operated business, we understand the unique
              needs of Southern Illinois communities. Our team is committed to
              providing personalized service and standing behind our work.
            </p>
