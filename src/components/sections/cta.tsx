      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-background/80 text-lg mb-8 max-w-2xl mx-auto">
            Whether you need a new build, renovation, or commercial construction,
            our team is ready to help. Contact us today for a free estimate and discover
          ...
          <p className="mt-8 text-background/60 text-sm">
            Free estimates. No obligation. Just honest advice from construction experts.
          </p>
        </div>
      </div>
    </section>
